		...
		<div class="col-lg-6">
		 ...
		 <form method="POST" action="{{ route('login') }}" class="contact-form text-center">
            ...
            <div class="contact-form__header mb-5" style="color:black;">
              <h6 class="contact-form__title mb-3">Please Register</h6>
              {{-- <p class="contact-form__paragraph mb-0 mx-auto">
               L
              </p> --}}
            </div>
            <input type="text" class="contact-form__input" placeholder="Name"  name="email" :value="old('email')" required autofocus>
            <input type="number" class="contact-form__input" placeholder="Customer Number"  name="email" :value="old('email')" required autofocus>
            <input type="email" class="contact-form__input" placeholder="Email"  name="email" :value="old('email')" required autofocus>
            <input type="tel" class="contact-form__input" placeholder="Phone"  name="email" :value="old('email')" required autofocus>


            <input type="password" class="contact-form__input" placeholder="Password" name="password" required autocomplete="current-password">
            <input type="password" class="contact-form__input" placeholder="Confirm Password" name="password" required autocomplete="current-password">
